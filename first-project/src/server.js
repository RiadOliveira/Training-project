...
const {index, allMovies, individualMovie, buyTicket, logged, sigAndLog, createAccount, confirmAccount, completeLogin, addCard, searchMovies, advanceDay, returnDay, buyFinalization, successBuy} = require('./pages');
